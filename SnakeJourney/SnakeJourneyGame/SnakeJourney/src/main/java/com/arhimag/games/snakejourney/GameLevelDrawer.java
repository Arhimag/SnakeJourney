...
public class GameLevelDrawer
{
	...
	*/
    ...
    private static final int studyColor = 0x99FFFFFF;
    ...
    private int teachingAnimationSlide = 0;
    private int accelSlide = ACCEL_0_LABEL;
    private int previousShownAction = 0;
    private int slideStopper = 1;
	...
	public GameLevelDrawer( GameLevel level, int screenWidth, int screenHeight, Graphics graphics )
	{
		...
		GameLevelDrawer.mapColorModificators[1][1] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[1][0] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[2][0] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[0][1] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[2][1] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[0][2] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[1][2] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
		GameLevelDrawer.mapColorModificators[2][2] = ( rand.nextInt(mapBitShift) << 16 | rand.nextInt(mapBitShift) << 8 | rand.nextInt(mapBitShift));
	...
	public static int getColor(char cellValue, int i, int j  )
	{
		switch( cellValue )
		{
            ...
            case '%':
                return 0xffdd5555 + mapColorModificators[i % 3][j % 3];
            case 'J':
                return 0xff8bc349 + mapColorModificators[i % 3][j % 3];
            case 'd':
                return 0xff7f37f0 + mapColorModificators[i % 3][j % 3];
            case 'o':
                return 0xffe9a159 + mapColorModificators[i % 3][j % 3];
            case 'j':
                return 0xff5ad32c + mapColorModificators[i % 3][j % 3];
			default:
				return mapWallColors[mapWallColors.length - 1];
		}
	}
	...
	public void drawMapMiniature(GameMap map, int mapStartDrawX, int mapStartDrawY, int width, int height, int eggsCount, int eggPixelSize )
	{
		if( !map.isColorsInited())
			map.initFlatMapColor();
		int mapPixelSize = java.lang.Math.min((height)/map.getMapHeight(), (width)/map.getMapWidth() );
        float floatmapPixelSize  = java.lang.Math.min(((float)height)/(float)map.getMapHeight(), ((float)width)/(float)map.getMapWidth() );
        float floatmapStartDrawX = (float)mapStartDrawX + ((float) width - (float)map.getMapWidth() * floatmapPixelSize) / 2;
        float floatmapStartDrawY= (float)mapStartDrawY + ((float) height - (float)map.getMapHeight() * floatmapPixelSize) / 2;
        if ( floatmapPixelSize <= 2.0 )
        {
            mapStartDrawX = java.lang.Math.round(floatmapStartDrawX);
            mapStartDrawY = java.lang.Math.round(floatmapStartDrawY);
        }
        else
        {
            mapStartDrawX += (width - map.getMapWidth() * mapPixelSize) / 2;
		...
		for(int i = 0; i < map.getMapWidth() ; i++ )
			for(int j=0; j < map.getMapHeight(); j++)
				if( floatmapPixelSize > 2 )
                    graphics.drawRect(mapStartDrawX + i * mapPixelSize, mapStartDrawY + j * mapPixelSize, mapPixelSize, mapPixelSize, map.getFlatMapColor(i, j));
                else
                    if( java.lang.Math.round( (float) i * floatmapPixelSize )/2 !=  java.lang.Math.round( (float) (i - 1) * floatmapPixelSize )/2 && java.lang.Math.round( (float) j * floatmapPixelSize )/2 !=  java.lang.Math.round( (float) (j - 1) * floatmapPixelSize  )/2 )
                        graphics.drawRect(mapStartDrawX + java.lang.Math.round( (float) i * floatmapPixelSize ), mapStartDrawY + java.lang.Math.round( (float) j * floatmapPixelSize ), 2, 2, map.getFlatMapColor(i, j));
		if( floatmapPixelSize > 2)
        {
            if (eggsCount > 0)
            {
        ...
        else
        {
            if (eggsCount > 0)
            {
                graphics.drawRect(mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - EggsWindowMap.Egg[0].length * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, EggsWindowMap.Egg[0].length * eggPixelSize, EggsWindowMap.Egg.length * eggPixelSize, 0xFF000000);
                drawLabel(EGG, mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - EggsWindowMap.Egg[0].length * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, eggPixelSize);
            }
            if (eggsCount > 1)
            {
                graphics.drawRect(mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - (2 * EggsWindowMap.Egg[0].length + 1) * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, EggsWindowMap.Egg[0].length * eggPixelSize, EggsWindowMap.Egg.length * eggPixelSize, 0xFF000000);
                drawLabel(EGG, mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - (2 * EggsWindowMap.Egg[0].length + 1) * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, eggPixelSize);
            }
            if (eggsCount > 2)
            {
                graphics.drawRect(mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - (3 * EggsWindowMap.Egg[0].length + 2) * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, EggsWindowMap.Egg[0].length * eggPixelSize, EggsWindowMap.Egg.length * eggPixelSize, 0xFF000000);
                drawLabel(EGG, mapStartDrawX + java.lang.Math.round(map.getMapWidth() * floatmapPixelSize) - (3 * EggsWindowMap.Egg[0].length + 2) * eggPixelSize, mapStartDrawY + java.lang.Math.round(map.getMapHeight() * floatmapPixelSize) - EggsWindowMap.Egg.length * eggPixelSize, eggPixelSize);
            }
        }
	}
...
/*		
    ...
    private static final int SOUNDVIBER_LABEL = 7;
    private static final int VIBER_LABEL = 8;
    ...
    private static final int MIN_FINGER_LABEL = 40;
    private static final int MED_FINGER_LABEL = 41;
    private static final int MAX_FINGER_LABEL = 42;

    private static final int ACCEL_0_LABEL = 50;
    private static final int ACCEL_R1_LABEL = 51;
    private static final int ACCEL_L1_LABEL = 52;
    private static final int ACCEL_R2_LABEL = 53;
    private static final int ACCEL_L2_LABEL = 54;
    private static final int ACCEL_R3_LABEL = 55;
    private static final int ACCEL_L3_LABEL = 56;

    private static final int SLIDE_ARROW_UP_LABEL = 60;
    private static final int SLIDE_ARROW_DOWN_LABEL = 61;
    private static final int SLIDE_ARROW_RIGHT_LABEL = 62;
    private static final int SLIDE_ARROW_LEFT_LABEL = 63;

    private static boolean accelAnimationClockDirection = true;

    public int nextAccelLabel( int accelLabel )
    {
        if( accelAnimationClockDirection )
        {
            switch( accelLabel )
            {
                case ACCEL_0_LABEL:
                    return ACCEL_R1_LABEL;
                case ACCEL_R1_LABEL:
                    return ACCEL_R2_LABEL;
                case ACCEL_L1_LABEL:
                    return ACCEL_0_LABEL;
                case ACCEL_R2_LABEL:
                    return ACCEL_R3_LABEL;
                case ACCEL_L2_LABEL:
                    return ACCEL_L1_LABEL;
                case ACCEL_R3_LABEL:
                    accelAnimationClockDirection = false;
                    return ACCEL_R2_LABEL;
                case ACCEL_L3_LABEL:
                    return ACCEL_L2_LABEL;
            }
        }
        else
        {
            switch( accelLabel )
            {
                ...
                case ACCEL_R2_LABEL:
                    return ACCEL_R1_LABEL;
                case ACCEL_L2_LABEL:
                    return ACCEL_L3_LABEL;
                case ACCEL_R3_LABEL:
                    return ACCEL_R2_LABEL;
                case ACCEL_L3_LABEL:
                    accelAnimationClockDirection = true;
                    return ACCEL_L2_LABEL;
            }
        }
    ...
    public void drawLabel( int label )
	{
		switch(label)
		{
			case SOUND_LABEL:
				...
				break;
            case SOUNDVIBER_LABEL:
                for(int i = 0; i < SettingsMap.soundLabel[0].length ; i++ )
                    for(int j = 0; j < SettingsMap.soundLabel.length; j++)
                        switch (SettingsMap.soundViberLabel[j][i])
                        {
                            case 'S':
                                graphics.drawRect(mapStartDrawX + ( SettingsMap.getSoundBounds().left + i ) * mapPixelSize, this.mapStartDrawY + ( SettingsMap.getSoundBounds().top + j ) * mapPixelSize, mapPixelSize, mapPixelSize, activeSettingsColors + mapColorModificators[i % 3][j % 3]);
                                break;
            ...
            case VIBER_LABEL:
                for(int i = 0; i < SettingsMap.soundLabel[0].length ; i++ )
                    for(int j = 0; j < SettingsMap.soundLabel.length; j++)
                        switch (SettingsMap.viberLabel[j][i])
                        {
                            case 'S':
                                graphics.drawRect(mapStartDrawX + ( SettingsMap.getSoundBounds().left + i ) * mapPixelSize, this.mapStartDrawY + ( SettingsMap.getSoundBounds().top + j ) * mapPixelSize, mapPixelSize, mapPixelSize, activeSettingsColors + mapColorModificators[i % 3][j % 3]);
                                break;
			...
			case LEFTRIGHT_LABEL:
				...
				break;			
			case NEXTLIST_LABEL:
				if((System.nanoTime() - animationTime) / 1000000000.0f > 0.15f)
				{
	...
	public void drawLabel( int label, int x, int y, int pixelsize )
	{
		...
		switch( label )
		{
			case EGG:
				...
				break;
            case ACCEL_0_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
                for(int i = 1; i < 3; i++ )
                {
                    graphics.drawRect(x + i * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                    graphics.drawRect(x - i * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                }
                break;
            case ACCEL_R1_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 2 * mapPixelSize, y - mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 3 * mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 3 * mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case ACCEL_L1_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
            ...
            case ACCEL_R2_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 2 * mapPixelSize, y - mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 3 * mapPixelSize, y + 2 * mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 3 * mapPixelSize, y - 2 * mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case ACCEL_L2_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
            ...
            case ACCEL_R3_LABEL :
                ...
                graphics.drawRect(x + mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y + 2 * mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 2 * mapPixelSize, y - 2 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 3 * mapPixelSize, y + 3 * mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 3 * mapPixelSize, y - 3 * mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case ACCEL_L3_LABEL :
                graphics.drawRect(x, y , pixelsize, pixelsize, studyColor);
                ...
                graphics.drawRect(x - 3 * mapPixelSize, y + 3 * mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case MIN_FINGER_LABEL :
                graphics.drawRect(x , y , pixelsize, pixelsize, studyColor);
                break;
            case MED_FINGER_LABEL :
                graphics.drawRect(x , y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case MAX_FINGER_LABEL :
                graphics.drawRect(x , y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 2 * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                ...
                graphics.drawRect(x - mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                break;
            case SLIDE_ARROW_UP_LABEL:
                graphics.drawRect(x , y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 3 * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - 2 * mapPixelSize, y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + 2 * mapPixelSize, y - mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x - mapPixelSize, y - mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - 2 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y - 2 * mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + 2 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y + 2 * mapPixelSize , pixelsize, pixelsize, studyColor);
            ...
            case SLIDE_ARROW_RIGHT_LABEL:
                graphics.drawRect(x , y , pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + 2 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y + 3 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x , y - 2 * mapPixelSize, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y, pixelsize, pixelsize, studyColor);
                graphics.drawRect(x + mapPixelSize, y + mapPixelSize , pixelsize, pixelsize, studyColor);
		...
		if( eggShown == 0)
		{
            ...
            if(level.isFirstEggActive())
            {
                if (Settings.isSoundEnabled())
                    Assets.getEgg.play(1);
            }
            else
            {
                if (Settings.isSoundEnabled())
                    Assets.notGetEgg.play(1);
            }
	...
	private void drawStudyHints()
    {
        switch( ((LevelBottle) level).getNeedPlayerAction() )
        {
            case LevelBottle.ACCEL_DOWN:
            case LevelBottle.ACCEL_UP:
            case LevelBottle.ACCEL_LEFT:
            case LevelBottle.ACCEL_RIGHT:
                drawLabel( accelSlide, mapStartDrawX + 5 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize  );
                drawLabel( accelSlide, mapStartDrawX + 24 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize  );
                break;

            case LevelBottle.CLICK_DOWN:
                if ( teachingAnimationSlide % 6 == 0 || teachingAnimationSlide % 6 == 5 )
                {
                    drawLabel(MIN_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                    drawLabel(MIN_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 1 || teachingAnimationSlide % 6 == 4 )
                {
                    drawLabel(MED_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                    drawLabel(MED_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 2 || teachingAnimationSlide % 6 == 3 )
                {
                    drawLabel(MAX_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                    drawLabel(MAX_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 14 * mapPixelSize, mapPixelSize);
                }
                break;
            case LevelBottle.CLICK_LEFT:
                if ( teachingAnimationSlide % 6 == 0 || teachingAnimationSlide % 6 == 5 )
                {
                    drawLabel(MIN_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 1 || teachingAnimationSlide % 6 == 4 )
                {
                    drawLabel(MED_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 2 || teachingAnimationSlide % 6 == 3 )
                {
                    drawLabel(MAX_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                break;
            case LevelBottle.CLICK_UP:
                if ( teachingAnimationSlide % 6 == 0 || teachingAnimationSlide % 6 == 5 )
                {
                    drawLabel( MIN_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                    drawLabel( MIN_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                }
                else if ( teachingAnimationSlide % 6 == 1 || teachingAnimationSlide % 6 == 4 )
                {
                    drawLabel( MED_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                    drawLabel( MED_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                }
                else if ( teachingAnimationSlide % 6 == 2 || teachingAnimationSlide % 6 == 3 )
                {
                    drawLabel( MAX_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                    drawLabel( MAX_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 2 * mapPixelSize, mapPixelSize  );
                }
                break;
            case LevelBottle.CLICK_RIGHT:
                if ( teachingAnimationSlide % 6 == 0 || teachingAnimationSlide % 6 == 5 )
                {
                    drawLabel(MIN_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 1 || teachingAnimationSlide % 6 == 4 )
                {
                    drawLabel(MED_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                else if ( teachingAnimationSlide % 6 == 2 || teachingAnimationSlide % 6 == 3 )
                {
                    drawLabel(MAX_FINGER_LABEL, mapStartDrawX + 26 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
                break;

            case LevelBottle.TURN_LEFT:
                if ( teachingAnimationSlide % 6 == 0 || teachingAnimationSlide % 6 == 5 )
                {
                    drawLabel(MIN_FINGER_LABEL, mapStartDrawX + 3 * mapPixelSize, this.mapStartDrawY + 8 * mapPixelSize, mapPixelSize);
                }
            ...
            case LevelBottle.SLIDE_DOWN:
                drawLabel(SLIDE_ARROW_DOWN_LABEL, mapStartDrawX + mapPixelSize * (level.getMap().getMapWidth() / 2) - mapPixelSize, mapStartDrawY + 2 * mapPixelSize + mapPixelSize * (teachingAnimationSlide % (6 * slideStopper))  * java.lang.Math.round(((level.getMap().getMapHeight()) / ((float)6 * (float)slideStopper))), mapPixelSize );
                break;
            case LevelBottle.SLIDE_UP:
                drawLabel(SLIDE_ARROW_UP_LABEL, mapStartDrawX + mapPixelSize * (level.getMap().getMapWidth() / 2) - mapPixelSize, mapStartDrawY + (level.getMap().getMapHeight() - 2) * mapPixelSize - mapPixelSize *  (teachingAnimationSlide % (6 * slideStopper))  * java.lang.Math.round(((float)(level.getMap().getMapHeight()) / ((float)6 * (float)slideStopper))), mapPixelSize );
                break;
            case LevelBottle.SLIDE_LEFT:
                drawLabel(SLIDE_ARROW_LEFT_LABEL, mapStartDrawX + (level.getMap().getMapWidth() - 3) * mapPixelSize - mapPixelSize * (teachingAnimationSlide % (6 * slideStopper)) * java.lang.Math.round((((float) level.getMap().getMapWidth()) / ((float)6 * (float)slideStopper)) ), mapStartDrawY + mapPixelSize * (level.getMap().getMapHeight() / 2), mapPixelSize );
                break;
            case LevelBottle.SLIDE_RIGHT:
                drawLabel(SLIDE_ARROW_RIGHT_LABEL, mapStartDrawX + 3 * mapPixelSize + mapPixelSize * (teachingAnimationSlide % (6 * slideStopper)) * java.lang.Math.round((((float)level.getMap().getMapWidth()) / ((float)6 * (float)slideStopper))), mapStartDrawY + mapPixelSize * (level.getMap().getMapHeight() / 2), mapPixelSize );
                break;
        }
    }
	...
	private void drawAchievements( int startDrawAchX, int startDrawAchY)
	{
		...
		int verticalSpace = ( level.getMap().getMapHeight() * mapPixelSize / LevelAchievementsList.achievementsPerList);
	...
	{	
		if( level instanceof SettingsLevel )
		{
			...
			if(Settings.isSoundEnabled())
                if (Settings.isViberEnabled())
				    drawLabel(SOUNDVIBER_LABEL);
                else
                    drawLabel(SOUND_LABEL);
            else if (Settings.isViberEnabled())
                drawLabel(VIBER_LABEL);
        ...
        else if( level instanceof LevelBottle )
        {
            if((System.nanoTime() - animationTime) / 1000000000.0f > 0.15f)
            {
                animationTime = System.nanoTime();
                teachingAnimationSlide = ( teachingAnimationSlide + 1 ) % 6;
                accelSlide = nextAccelLabel(accelSlide);
            }
            if(  ((LevelBottle) level).getNeedPlayerAction() != previousShownAction )
            {
                animationTime = System.nanoTime();
                teachingAnimationSlide = 0;
                previousShownAction = ((LevelBottle) level).getNeedPlayerAction();
            }
		...
		else if( level instanceof LevelLevelsList)
		{
			...
			int ltmapX  = mapStartDrawX + ((LevelLevelsList)level).getLtmapX() * mapPixelSize;
			int ltmapY  = mapStartDrawY + ((LevelLevelsList)level).getLtmapY() * mapPixelSize;
			int rtmapX  = mapStartDrawX + ((LevelLevelsList)level).getRtmapX() * mapPixelSize;
			int rtmapY  = mapStartDrawY + ((LevelLevelsList)level).getRtmapY() * mapPixelSize;
			int lbmapX  = mapStartDrawX + ((LevelLevelsList)level).getLbmapX() * mapPixelSize;
			int lbmapY  = mapStartDrawY + ((LevelLevelsList)level).getLbmapY() * mapPixelSize;
			int rbmapX  = mapStartDrawX + ((LevelLevelsList)level).getRbmapX() * mapPixelSize;
			int rbmapY  = mapStartDrawY + ((LevelLevelsList)level).getRbmapY() * mapPixelSize;
			int eggSize = Math.max( mapPixelSize / 4, 2 );
		...
		{
		    if( level.getMessageScreen() && level.getMessageScreenMap() != null )
            {
                int messageMapPixelSize = java.lang.Math.min((screenHeight - paddingTop - paddingBottom)/level.getMessageScreenMap().getMapHeight(), (screenWidth - paddingRight - paddingLeft)/level.getMessageScreenMap().getMapWidth() );
                int messageMapStartDrawX = paddingLeft + (screenWidth  - paddingRight - paddingLeft - messageMapPixelSize*level.getMessageScreenMap().getMapWidth()) / 2 ;
                int messageMapStartDrawY = paddingTop + (screenHeight - paddingTop - paddingBottom - level.getMessageScreenMap().getMapHeight()*messageMapPixelSize ) /2;

                if(! level.getMessageScreenMap().isColorsInited())
                    level.getMessageScreenMap().initFlatMapColor();
                for(int i = 0; i < level.getMessageScreenMap().getMapWidth() ; i++ )
                    for(int j=0; j < level.getMessageScreenMap().getMapHeight(); j++)
                        graphics.drawRect(messageMapStartDrawX + i * messageMapPixelSize, messageMapStartDrawY + j * messageMapPixelSize, messageMapPixelSize, messageMapPixelSize, level.getMessageScreenMap().getFlatMapColor(i, j));
	...
	{
		return ( ( event.x > paddingLeft + rct.left * mapPixelSize + mapStartDrawX) &&
	...
	public boolean inBoundsEgg( TouchEvent event, Rect rct)
	{
		...
		return ( ( event.x > paddingLeft + rct.left * winPixelSize + winStartDrawX) &&
    ...
    public boolean inBoundsMessage( TouchEvent event, Rect rct)
    {
        int messageMapPixelSize = java.lang.Math.min((screenHeight - paddingTop - paddingBottom)/level.getMessageScreenMap().getMapHeight(), (screenWidth - paddingRight - paddingLeft)/level.getMessageScreenMap().getMapWidth() );
        int messageMapStartDrawX = paddingLeft + (screenWidth  - paddingRight - paddingLeft - messageMapPixelSize*level.getMessageScreenMap().getMapWidth()) / 2 ;
        int messageMapStartDrawY = paddingTop + (screenHeight - paddingTop - paddingBottom - level.getMessageScreenMap().getMapHeight()*messageMapPixelSize ) /2;
        ...
        return ( ( event.x > paddingLeft + rct.left * messageMapPixelSize + messageMapStartDrawX) &&
                ( event.x <  paddingLeft + rct.right * messageMapPixelSize + messageMapStartDrawX  ) &&
                ( event.y > paddingTop + rct.top * messageMapPixelSize + messageMapStartDrawY) &&
                ( event.y <  paddingTop + rct.bottom * messageMapPixelSize + messageMapStartDrawY  ) );
    }
