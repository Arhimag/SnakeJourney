...
public class LevelSequence 
{
    private static final  Class<?> levels[] = {
        ...
        LevelBalcony.class,     LevelLabirinth.class,           MeetTeleportLevel.class,
        LevelZigZag.class,      LevelSlalom.class,              LevelClassic.class,
        LevelMask.class,        LevelTorii.class,               LevelForest.class,
        LevelTrefoil.class,     LevelHypno.class,               LevelMiniSquare.class,
    ...
    private static final Class<?> maps[] = {
        ...
        LevelBalconyMap.class,         	LevelLabirinthMap.class, 		MeetTeleportMap.class,
        LevelZigZagMap.class,           LevelSlalomMap.class,       	LevelClassicMap.class,
        MaskMap.class,                  LevelToriiMap.class,            LevelForestMap.class,
        LevelTrefoilMap.class,          LevelHypnoMap.class,            LevelMiniSquareMap.class,
