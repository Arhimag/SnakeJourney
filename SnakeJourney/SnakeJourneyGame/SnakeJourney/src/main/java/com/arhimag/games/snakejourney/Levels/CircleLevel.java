...
import com.arhimag.games.snakejourney.AI.SimpleAISnake;
...
public class CircleLevel extends GameLevel
{
	public CircleLevel(  GameMap map )
	{
		...
		egg1 = (long)1200 * (long)1000000000 - 1; // 1 ���
		egg2 = (long)480 * (long)1000000000; // 5 �����
		egg3 = (long)240 * (long)1000000000; // 1,5 ������
