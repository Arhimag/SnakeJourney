...
public class Settings
{
    ...
    private static boolean viberEnabled = true;
	private static int control = 0;
	private static final int programmVersion = 45;
...
//	private static int isFutureMovement = 1;
    ...
    private static final int CODE_VIBER = 9;
	...
	public static void save( FileIO files)
	{
		...
		try
		{
			...
			out.newLine();
            out.write(Integer.toString(CODE_VIBER));
            out.newLine();
            out.write(Boolean.toString(viberEnabled));
            out.newLine();
    ...
    public static boolean isViberEnabled() { return viberEnabled; }
    public static void setViberEnabled( boolean newViberEnabled ) { viberEnabled = newViberEnabled; }
    ...
    private static void setToDebug()
    {
        if( DEBUG )
        {
            lastReachedLevel = 35;
		...
		try 
		{
			...
			switch(code)
			{
				case CODE_SOUND:
					...
					return true;
                case CODE_VIBER:
                    viberEnabled = Boolean.parseBoolean(in.readLine());
                    return true;
				case CODE_CONTROL:
