...
public class LevelZigZag extends GameLevel
{
	public LevelZigZag(  GameMap map )
	{
		...
		finishes[0] = new Point(14,18);
		finishes[1] = new Point(15,18);
		finishes[5] = new Point(16,18);
		finishes[2] = new Point(17,18);
		finishes[3] = new Point(18,18);
		finishes[4] = new Point(19,18);
